...
export class ManageDoctorsComponent implements OnInit, AfterViewInit{
  ...
  navBarData: INavBarDetails = {
    ...
    menuItems: [
      ...
      { title: 'Requests', matIconType: 'local_hospital', path: 'admin/requests' },
      { title: 'Notifications', matIconType: 'local_hospital', path: 'admin/notifications' }
    ],
  };
  constructor() {}
